  ...
  return (
    <div className={styles.cvMainDiv}>
      ...
      <CvCard title={cv.education[2].about} description={cv.education[2].level}>
        ...
        <p>{cv.education[2].techstack[4]}</p>
        <p>{cv.education[2].techstack[5]}</p>
        </div>
      </CvCard>
      ...
      <p>{cv.worked[2].period2}</p>
        ...
        <div className={styles.cvCardTechStackDiv}>
        <p>{cv.worked[2].techstack[0]}</p>
        <p>{cv.worked[2].techstack[1]}</p>
        <p>{cv.worked[2].techstack[2]}</p>
        <p>{cv.worked[2].techstack[3]}</p>
        <p>{cv.worked[2].techstack[4]}</p>
        <p>{cv.worked[2].techstack[5]}</p>
        </div>
      </CvCard>
